...
def process_images_with_array(base_array, input_dir1, input_dir2):
    """
    Process images from two folders using the base array and merge into one result array

    Parameters:
    base_array: The base array
    input_dir1: Path to the first input folder
    input_dir2: Path to the second input folder

    Returns:
    result_array: Merged result array
    """
    all_image_files = []
...
def main():
    ...
    output_excel = "./stdp_similar.xlsx"  # Output Excel file
    output_png = "./stdp_similar.png"  # Output PNG file
